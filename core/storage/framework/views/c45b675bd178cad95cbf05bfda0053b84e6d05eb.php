                ...
                <div class="site-card">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <button type="submit" class="btn main-btn w-100" id="basic-addon2"><span><?php echo e(__('Apply Coupon')); ?></span></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make(template() . 'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\99451\Desktop\Scripts_v10\core\resources\views/theme5/user/apply_coupon.blade.php ENDPATH**/ ?>