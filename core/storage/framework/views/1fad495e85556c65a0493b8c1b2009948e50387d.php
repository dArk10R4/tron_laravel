<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-caption"><?php echo e(__('Coupon')); ?></li>

            <?php if(auth()->guard('admin')->user()->can('manage-coupon')): ?>
                <li class="nav-item dropdown <?php echo e(menuActive('admin.coupon*')); ?>">
...
<?php /**PATH C:\Users\99451\Desktop\Scripts_v10\core\resources\views/backend/layout/sidebar.blade.php ENDPATH**/ ?>