                ...
                <div class="banner-content text-lg-start text-center">
                    ...
                    <div class="banner-btn-group justify-content-lg-start justify-content-center mt-4">
                        <a href="<?php echo e(__(@$content->data->button_text_link)); ?>"
                            class="sp_theme_btn"><?php echo e(__(@$content->data->button_text)); ?></a>
                        <a href="<?php echo e(__(@$content->data->button_text_2_link)); ?>"
                            class="sp_border_btn"><?php echo e(__(@$content->data->button_text_2)); ?></a>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\99451\Desktop\Scripts_v10\core\resources\views/theme2/sections/banner.blade.php ENDPATH**/ ?>